from exec_env_option_v2 import ExecEnv1, ExecEnv_option
from karel_env.dsl.dsl_parse import parse

import gymnasium as gym
from gymnasium import spaces
from karel_world import Karel_world, KarelStateGenerator
import numpy as np

class KarelProgramEnv(gym.Env):
    """MDP3
