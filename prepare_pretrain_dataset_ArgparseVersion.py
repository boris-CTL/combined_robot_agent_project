...
if __name__ == "__main__":
    ...
    argparser.add_argument('--reward_interval', '-r', type=str, default='None', dest='reward_interval')
    ...
    folder_path = "llm_generated_trajectories"
    count_list = []
    ...
    for SEED_NUMBER in seed_lists:
        for task_idx in range(task_per_seed):
            ...
            print(npz_file_path)
            if npz_file_path in key_list or key_list==[]:
