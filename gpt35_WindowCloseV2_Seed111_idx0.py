...
def produce_initial_response(logger, initial_state_info, b_instruction, gpt = "gpt-3.5-turbo", temperature = 0.3):
...
# should be done modified.
# 20240328, done
def produce_feedback_response(logger, current_state_info, b_instruction, reward_feedback, gpt = "gpt-3.5-turbo", temperature = 0.3):
    with open('llm/system_prompt_MetaWorldWindowCloseV2_0411.txt', 'r') as file:
        system_prompt_contents = file.read()
